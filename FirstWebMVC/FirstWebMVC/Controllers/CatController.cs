...
namespace FirstWebMVC.Controllers
{
    public class CatController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,GiongLoai,XuatXu,TuoiTho")] Cat cat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Name,GiongLoai,XuatXu,TuoiTho")] Cat cat)
        {
            if (id != cat.GiongLoai)
            {
                return NotFound();
        ...
        {
          return (_context.Cat?.Any(e => e.GiongLoai == id)).GetValueOrDefault();
        }
    }
}
