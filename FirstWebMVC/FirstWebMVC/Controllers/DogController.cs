...
namespace FirstWebMVC.Controllers
{
    public class DogController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,GiongLoai,XuatXu,TuoiTho")] Dog dog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Name,GiongLoai,XuatXu,TuoiTho")] Dog dog)
        {
            if (id != dog.GiongLoai)
            {
                return NotFound();
        ...
        {
          return (_context.Dog?.Any(e => e.GiongLoai == id)).GetValueOrDefault();
        }
    }
}
